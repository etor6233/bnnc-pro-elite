...
| Claim | Evidence |
|---|---|
| HDR latency histogram (3 sig figs, [1 ns, 1 h]) with p50/p99/p99.9/p99.99, cross-validated 0 mismatches on 4 corpora | \cpp/bench/hdr_histogram.hpp\ + \cpp/evidence/10-latency-elite/PHASE1/\ (red/green logs, crosscheck_report.json verdict PASS) |
| HDR percentiles measured on every codec (e.g. ITCH decode p50 16 ns / p99.9 53 ns / p99.99 117 ns; JSON stdlib p50 1.5 µs / p99.99 48.1 µs) | \cpp/bench/benchmarks/bench_*_hdr.json\ + \cpp/evidence/10-latency-elite/PHASE1/EVIDENCE_PHASE1.md\ |
...
| False sharing measured: same-line vs alignas(64) — 5.4× p50 penalty, 4.7× throughput penalty | \cpp/bench/benchmarks/bench_false_sharing_*.json\ + \cpp/evidence/10-latency-elite/PHASE2/EVIDENCE_PHASE2.md\ |
| SPSC ring 1P/1C measured (push p50 48 ns incl. timestamp; pop p50 1 ns; 21.4M msg/s; explicit overflow) | \cpp/bench/benchmarks/bench_spsc_*.json\ + \cpp/evidence/10-latency-elite/PHASE2/EVIDENCE_PHASE2.md\ |
| Aeron IPC demo, real run: 1M messages, p50 400 ns / p99.99 1.54 ms (official jars, SHA256-recorded) | \cpp/evidence/10-latency-elite/PHASE3/AERON_IPC_REPORT.md\ |
| Kernel-bypass design reference (DPDK/OpenOnload/Machnet), pinned-commit citations, nothing faked | \cpp/bench/KERNEL_BYPASS_DESIGN.md\ + \cpp/evidence/10-latency-elite/PHASE4/MANIFEST_PHASE4.md\ |
