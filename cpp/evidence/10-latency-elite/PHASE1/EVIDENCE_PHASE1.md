# PHASE 1 evidence — HDR latency histogram in C++ + percentile integration
...
|---|---|---|
| HDR histogram (header-only C++20) | `cpp/bench/hdr_histogram.hpp` | *(see `MANIFEST_PHASE1.md`)* |
| Unit tests (AFX harness) | `cpp/bench/tests/test_hdr.cpp` | *(see `MANIFEST_PHASE1.md`)* |
| CLI driver for the cross-check | `cpp/bench/tools/hdr_cli.cpp` | *(see `MANIFEST_PHASE1.md`)* |
| Independent Python reference | `cpp/bench/tools/hdr_reference.py` | *(see `MANIFEST_PHASE1.md`)* |
| Cross-check runner + report | `cpp/bench/tools/crosscheck_hdr.py`, `crosscheck_report.json` | *(see `MANIFEST_PHASE1.md`)* |
| Red log (test before implementation) | `PHASE1/red.log` | *(see `MANIFEST_PHASE1.md`)* |
| Green log (test after implementation) | `PHASE1/green.log` | *(see `MANIFEST_PHASE1.md`)* |
| HDR percentile reports (measured) | `cpp/bench/benchmarks/bench_*_hdr.json` | *(see `MANIFEST_PHASE1.md`)* |

SHA-256 values are computed and listed in `MANIFEST_PHASE1.md` (generated at
...
4. Suite ran and passed: **10 passed, 0 failed** (`PHASE1/green.log`).
...
`PASS`), copy in `PHASE1/crosscheck_report.json`.
...
- Suite green: **10/10** (`PHASE1/green.log`; also runs inside
