# PHASE 6 evidence — professional presentation + final scan
...
## Final scan (script committed: `PHASE6/scan_publication.ps1`)

Full output: `PHASE6/scan_20260919.txt`. Results:
...
| Mermaid blocks (root README) | **PASS** with the real parser (mermaid 11.17.2, headless jsdom setup; log: `PHASE6/mermaid_verify.txt`) |
...
(`PHASE1/all_phases_green_20260919.log`, `PHASE3/aeron-ipc/*.log`) are verbatim
