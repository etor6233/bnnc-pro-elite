...
| FASE 5: CI artifacts + Pages + badge + verificación 5 minutos | [x] DONE | `.github/workflows/ci.yml` (job `cpp-bench`, artifacts en Linux+Windows) + `cpp/bench/tools/make_pages_report.py` + `bench-latency/index.html` + badges en README + `cpp/evidence/10-latency-elite/FASE5/` |
